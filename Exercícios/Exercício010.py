...
carteira = float(input('Digite o valor disponível na sua carteira: R$')) #O valor será guardado na variável carteira.
DolarHoje = 5.37 #O valor do dólar está sendo guardado aqui.
